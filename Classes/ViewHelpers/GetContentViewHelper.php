...
class Tx_PwTeaser_ViewHelpers_GetContentViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper {
	...
	/**
	 *
	 * @param array<Tx_PwTeaser_Domain_Model_Content> $contents array which
	 *        contains content elements
	 * @param string $as the name of the iteration variable
	 * @param integer $colPos column position to get content elements from,
	 *        default is 0 (normal)
	 * @param string $cType the cType to filter content elements for, default is
	 *        NULL
	 * @param integer $index limits the output to n-th element. default is NULL
	 *        which disables the limitation, 0 would limit the output to the
	 *        first found content element
